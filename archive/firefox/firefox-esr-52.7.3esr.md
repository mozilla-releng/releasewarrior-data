...
### Graphs
* [promote](https://tools.taskcluster.net/push-inspector/#/ShBXQAeNQbGhdYmEdDJF5Q) ShBXQAeNQbGhdYmEdDJF5Q
* [ship](https://tools.taskcluster.net/push-inspector/#/azM2e3PjTV-kUd_j_2TGMw) azM2e3PjTV-kUd_j_2TGMw
...
| ------------------- | ---------------- | ------------------------------------------------------------------- | -------------------------- | ----------------------- | ---------------------------- |
| asasaki  | 1 | [bug 1445666](https://bugzil.la/1445666)        | only updated the esr52-latest* aliases, not the esr-latest* | True | True |
...
| Who                 | ID               | Bug                                                                 | Description                | Resolved                | Future Threat                |
| ------------------- | ---------------- | ------------------------------------------------------------------- | -------------------------- | ----------------------- | ---------------------------- |
| jlorenzo  | 1 | [bug none](https://bugzil.la/none)        | Wrong changeset given on ship it. Build 1 waits on builds that will never come. Build2 started. | True | False |
