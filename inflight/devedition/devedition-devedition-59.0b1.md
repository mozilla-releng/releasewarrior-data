...
[task group](https://tools.taskcluster.net/push-inspector/#/eVYBc0thSpuowdDy2wxkLQ)
[task group](https://tools.taskcluster.net/push-inspector/#/MXq8lt5HS12lrvnSn7_A0Q)


#### Status
- [x] 1.  [how-to](https://wiki.mozilla.org/Release:Release_Automation_on_Mercurial:Starting_a_Release#Submit_to_Ship_It)  - submit to Shipit
- [x] 2.  [how-to](https://bugzilla.mozilla.org/show_bug.cgi?id=1412962)  - Validate new locale (ia) was built and is ready
- [x] 3.  [how-to](https://github.com/mozilla-releng/releasewarrior-2.0/wiki/Release-Promotion-Tasks-TC#push-artifacts-to-releases-directory)  - pushed to mirrors/releases
- [x] 4.  [how-to](https://github.com/mozilla-releng/releasewarrior-2.0/wiki/Release-Promotion-Tasks-TC#publish-the-release)  - publish release tasks
- [x] 5.  [how-to](https://github.com/mozilla-releng/releasewarrior-2.0/wiki/Release-Promotion-Tasks-TC#obtain-sign-offs-for-changes)  - signoff in Balrog
- [x] 6.  - (maybe) manually tag and version bump devedition

### Issues
| Who                 | ID               | Bug                                                                 | Description                | Resolved                | Future Threat                |
| ------------------- | ---------------- | ------------------------------------------------------------------- | -------------------------- | ----------------------- | ---------------------------- |
| callek  | 1 | [bug 1431152](https://bugzil.la/1431152)        | Version bumping for devedition fails due to invalid config file. | True | True |

## Build 10  :bomb: _aborted release. starting new build num_ :bomb: 

### Graphs
[task group](https://tools.taskcluster.net/push-inspector/#/bZOzB1olQcmJQ3dK_gnntA)
...
- [ ] 6.  - (maybe) manually tag and version bump devedition
...
### Graphs
[task group](https://tools.taskcluster.net/push-inspector/#/A48U4LBZSh6MyIl_4kCBEw)
...
## Build 8  :bomb: _aborted release. starting new build num_ :bomb: 
