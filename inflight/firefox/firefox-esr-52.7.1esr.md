...
| bhearsum  | 2 | [bug none](https://bugzil.la/none)        | had to manually schedule changes to rules because we were only shipping this release to the "it" locale | True | False |
